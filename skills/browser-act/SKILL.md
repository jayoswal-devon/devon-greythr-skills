...
Browser automation CLI for AI agents. Runs a full browser engine: navigation & interaction, data extraction & network capture, screenshots, form automation, multi-browser parallel operation, and human-agent collaboration.
...
- Human-agent collaboration — headed mode for manual steps

Install: `uv tool install browser-act-cli --python 3.12`

## Start here

Before running any `browser-act` command, load the core-skills usage guide from this file [core-skills](./core-skills/core-skills.md):

- start here — workflows, common patterns, troubleshooting

**Do NOT skip this step regardless of how simple the command seems.**

**Do NOT truncate the content of file** — it contains operational directives and
...
`core-skills` provides environment status, available browsers, operational
