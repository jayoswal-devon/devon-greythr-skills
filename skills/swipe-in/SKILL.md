---
name: swipe-in
description: Swipe-in skills to mark attendance on Greythr portal
---
# Pre-Requisites
...
5. After successful login, on the central area there will be Sign In button, it will be placed along with Day, Date, View Swipes link. the button could be Sign In or Sign Out depending on what previous swipe was, and it allows multiple swipes per day
6. If button is Swipe Out, then dont click it, skip this step
7. If button is Swipe In, then click it, it opens another modal, choose Office from dropdown (Enter Sign in location)and click Sign In
